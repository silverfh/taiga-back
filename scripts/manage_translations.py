...
##################################################################
####         INSTRUCTIONS BEFORE TO USE THIS SCRIPTS:         ####
##################################################################
#
# 1. Install transifex-client (it works with
#    python 2.x)
#       $ pip2.7 install --user transifex-client
#
# 2. initialize (generate ~/.transifexrc file)
#       $ tx init
#
# 3. Tests that all are Ok
#       $ tx status
#    and tho output must be something like this:
#       taiga-back -> main (1 of 2)
#       Translation Files:
#        - en: locale/en/LC_MESSAGES/django.po (source)
#
#       taiga-back -> taiga (2 of 2)
#       Translation Files:
#        - en: taiga/locale/en/LC_MESSAGES/django.po (source)
#
